...
import { Calendar, RefreshCw, Plus, Trash2, Download, FileText } from "lucide-react";
    ...
    },
    {
      ...
      render: (row) => (
        <Input
          value={row.threshold}
          onChange={(e) =>
            handleRowChange(row.id, "threshold", e.target.value)
          }
          className="w-20"
        />
      ),
    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="bg-white rounded-lg p-6 border">
          <h2 className="text-xl font-semibold mb-6">تعديل معلومات العقد</h2>
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            {formData.deferred === "yes" && (
              <div className="space-y-2">
                <Label htmlFor="deferredApprovalDate">
                  تاريخ اعتماد المؤجلات
                </Label>
                <Input
          ...
          <div className="grid grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("area4500", e.target.value)
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("glassColor", e.target.value)
                }
              />
            </div>
          </div>
